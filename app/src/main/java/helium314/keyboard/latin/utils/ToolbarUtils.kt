...
enum class ToolbarKey {
    ...
    PAGE_UP, PAGE_DOWN, FULL_LEFT, FULL_RIGHT, PAGE_START, PAGE_END, BACKGROUND_GATHERING, AI_COMMAND
}
...
val defaultToolbarPref by lazy {
    val default = listOf(SETTINGS, AI_COMMAND, VOICE, CLIPBOARD, UNDO, REDO, SELECT_WORD, COPY, PASTE, LEFT, RIGHT)
